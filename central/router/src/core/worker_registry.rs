    ...
    pub fn start_health_checker(&self, check_interval_secs: u64) -> crate::core::HealthChecker {
        ...
        let handle = tokio::spawn(async move {
            ...
            loop {
                ...
                // Removed: unconditional periodic load reset.
                // It zeroed live in-flight counters under load, which the gauge then
                // had to climb back from 0. With the increment/decrement bugs in the
                // request path now fixed, this drift "safety net" actively corrupts
